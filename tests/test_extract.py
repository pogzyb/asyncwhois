...
from asyncwhois import extract_domain


class TestExtractDomain(asynctest.TestCase):
    ...
    async def test_ascii_with_schema_path_and_query(self):
    ...
    async def test_ipv6(self):
        ...
        self.assertEqual(domain, await extract_domain(await extract_domain(url)))
